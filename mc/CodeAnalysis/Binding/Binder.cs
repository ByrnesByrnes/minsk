...
namespace mc.CodeAnalysis.Binding
{
	...
	internal sealed class Binder
	{
		...
		private BoundExpression BindUnaryExpression(UnaryExpressionSyntax syntax)
		{
			...
			{
				_diagnostics.Add($"Unary operator '{syntax.OperatorToken.Text}' is not defined for type {boundOperand}");
				return boundOperand;
			}
		...
		private BoundExpression BindBinaryExpression(BinaryExpressionSyntax syntax)
		{
			...
			{
				_diagnostics.Add($"Binary operator '{syntax.OperatorToken.Text}' is not defined for types {boundLeft} and {boundRight}");
				return boundLeft;
			}
